...
public class CamCont : MonoBehaviour
{
    ...
    #region Align
    [Header("Align")]
    [SerializeField, Min(0f)] private float alighDealy = 2f;
    ...
    private void Update()
    {
        ...
        //_orbitDistance += /*Input.mouseScrollDelta;*/ Mathf.Max(0.1f, Input.mouseScrollDelta.y * _zoomSpeed);
  ...
  /*  private float _lastDistance = -1f;
    ...
    private void UpdateFocusPoint()
    {
        ...
        if (_focusRadius > 0f)
        {
            ...
            //a = 5
            //b = 10
            //t = between 0 -1 ... this could equal t = b percent of a
